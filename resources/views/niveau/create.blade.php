...
<div class="card">
    <header class="card-header">
        <p class="card-header-title">Création d'un niveau</p>
    </header>
...
<form action="{{ route('niveaux.store') }}" method="POST">
    ...
    <div class="field">
        ...
        <div class="control">
          <input class="input @error('nom') is-danger @enderror" type="text" name="nom" value="{{ old('nom') }}" placeholder="entrez le nom du niveau">
        </div>
        @error('nom')
